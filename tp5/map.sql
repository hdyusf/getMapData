...
Source Server         : 地图青果服务器数据库
Source Server Version : 50559
Source Host           : 106.15.88.66:3306
Source Database       : map
...
-- ----------------------------
INSERT INTO `think_admin_user` VALUES ('1', 'admin', 'f4df47ad452cc58d8604fc8c4b64000a', '1', '2016-10-18 15:28:37', '2018-08-31 16:29:04', '115.60.165.211');
...
INSERT INTO `think_auth_rule` VALUES ('2', 'admin/System/siteConfig', '站点配置', '1', '0', '1', '', '0', '');
...
INSERT INTO `think_auth_rule` VALUES ('12', 'admin/Nav/index', '导航管理', '1', '0', '5', '', '0', '');
INSERT INTO `think_auth_rule` VALUES ('13', 'admin/Category/index', '栏目管理', '1', '1', '14', 'fa fa-sitemap', '0', '');
INSERT INTO `think_auth_rule` VALUES ('14', 'admin/Content/default', '内容管理', '1', '0', '0', 'fa fa-file-text', '0', '');
...
INSERT INTO `think_auth_rule` VALUES ('54', 'admin/Slide/default', '扩展管理', '1', '0', '0', 'fa fa-wrench', '0', '');
...
INSERT INTO `think_auth_rule` VALUES ('75', 'admin/password/index', '用户激活码', '1', '1', '16', '', '0', '');
...
-- ----------------------------
-- Table structure for `think_password`
-- ----------------------------
DROP TABLE IF EXISTS `think_password`;
CREATE TABLE `think_password` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `code` varchar(100) NOT NULL COMMENT '密码',
  `user_status` int(1) NOT NULL DEFAULT '0' COMMENT '0 用户未使用, 1 已激活',
  `status` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '用户状态  1 正常  2 禁止',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `pastdue_time` datetime DEFAULT NULL COMMENT '最后登陆时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=59 DEFAULT CHARSET=utf8 COMMENT='用户表';

-- ----------------------------
-- Records of think_password
-- ----------------------------
INSERT INTO `think_password` VALUES ('57', 'eaa5878ef0920d09e9d2d0334f3cdbdd', '1', '1', '2018-08-27 17:45:08', '2019-08-27 17:45:07');
INSERT INTO `think_password` VALUES ('58', '14edf0444c7e0dabea38014218cc74c1', '0', '1', '2018-08-27 17:45:11', '2019-08-27 17:45:11');
...
CREATE TABLE `think_user` (
  ...
  `is_login` int(1) NOT NULL DEFAULT '0' COMMENT '0 未登录, 1已登录',
  PRIMARY KEY (`id`),
  UNIQUE KEY `username` (`username`),
  KEY `user_password` (`password_code`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='用户表';

-- ----------------------------
-- Records of think_user
-- ----------------------------
INSERT INTO `think_user` VALUES ('8', 'eaa5878ef0920d09e9d2d0334f3cdbdd', 'yusen', '7b79e788e94c1c41b6d4e1b1280c4bdb', '', '', '1', '2018-08-27 17:45:32', null, '48:8a:d2:10:26:a3', '0');
